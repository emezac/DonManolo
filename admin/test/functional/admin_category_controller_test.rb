...
require 'admin_category_controller'

# Re-raise errors caught by the controller.
class AdminCategoryController; def rescue_action(e) raise e end; end

class AdminCategoryControllerTest < Test::Unit::TestCase
  fixtures :categories
